...
\begin{itemize}
 ...
 \item Their\textbf{ median RTT: 30--32\,ms }to 7.9k Atlas probes
   \begin{itemize}
     \item Wes: I think this should be strengthened and explained further
   \end{itemize}
\end{itemize}
...
\begin{itemize}
 ...
 \begin{itemize}
  \item A client in California may be answered by a site near NRT -- even 
though there is a closer site in SFO
 \end{itemize}
...
\begin{itemize}
 ...
 \item Caching is a \textit{key} component of domain's resilience
   \item Retries as well -- to the point that resolvers may ``hammer'' 
authoritatives
\begin{itemize}
\item this needs some wording fixes, but I failed... - wes
\end{itemize}
...
co-located sites also went down
